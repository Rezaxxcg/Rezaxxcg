...
echo -e "${PURPLE}__Reza__"
echo -e "${YELLOW}Pv:- @TheMesterReza "

echo -e "${GREEN}  1)XPanel v3.6"
echo -e "  2)XPanel v3.5"
echo -e "  3)XPanel v3.4"
echo -e "  4)XPanel v3.3"
echo -e "  5)XPanel v3.1"
echo -e "  6)XPanel v3.0"
echo -e "  7)XPanel v2.9"
echo -e "  8)XPanel v2.8"
...
if [ "$n" == "2" ]; then
linkd=https://api.github.com/repos/Alirezad07/X-Panel-SSH-User-Management/releases/tags/xpanelv35
fi
if [ "$n" == "3" ]; then
